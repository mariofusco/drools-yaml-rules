...
public class DurableRulesJsonTest {
    ...
    public void testExecuteRules() {
        long rulesId = compileRules(DurableNotation.INSTANCE, DURABLE_RULES_JSON);
    ...
    public void testProcessWithAnd() {
        ...
        long rulesId = compileRules(DurableNotation.INSTANCE, jsonRule);
        RulesExecutor rulesExecutor = RulesExecutor.createRulesExecutor(rulesId);
    ...
    private static long compileRules(DurableNotation durableNotation, String json) {
        RulesCompiler rulesCompiler = RulesCompiler.createFromJson(durableNotation, json);
